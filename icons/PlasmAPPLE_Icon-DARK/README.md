...
PlasmApple_Icon es una corrección muy pequeña del paquete de iconos Mojave Ct (para ser exactos a los iconos de Google_Chrome y Opera) combinandolo con el conocido We10X icon theme, esta combinación fue realizada por HBlanqueto (lo puedes encontrar así en su canal de Youtube) para todo publico.
